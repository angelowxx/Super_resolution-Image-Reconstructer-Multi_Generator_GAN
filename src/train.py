...
def train_example(rank, world_size, num_epochs):
    ...
    # Create DataLoaders
    train_loader = DataLoader(train_subset, batch_size=2, sampler=train_sampler, num_workers=0)
    val_loader = DataLoader(val_subset, batch_size=2, sampler=val_sampler, num_workers=0)
