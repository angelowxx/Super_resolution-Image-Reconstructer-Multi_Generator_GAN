...
def train_example(rank, world_size, num_epochs, continue_training, prefix):
    ...
    lr_scheduler = linearLR(optimizer=g_optimizer, start_factor=1, end_factor=0.1, total_iters=num_epochs)
    d_lr_scheduler = linearLR(optimizer=d_optimizer, start_factor=1, end_factor=0.1, total_iters=num_epochs)
...
def train_generator(generator, discriminator, lr_imgs, hr_imgs, vgg_extractor,
    ...
    g_loss = com_loss + tv_loss*0.05 + g_d_loss*0.1
